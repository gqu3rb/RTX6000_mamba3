...
import torch.nn as nn
from torch import Tensor
# Added Optional and Union for Python 3.8 compatibility
...
# Replaced Python 3.10 syntax (Tuple | None) with Optional
Cache = Optional[Tuple[Tensor, Tensor]]

# Replaced Python 3.10 syntax (T | None) and (T | D) with Optional and Union
def default(var : Optional[T], val : D) -> Union[T, D]:
    return val if var is None else var

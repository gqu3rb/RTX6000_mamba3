...
# Added Optional for Python 3.8 compatibility
...
class MambaLLM(LightningModule):
    ...
    def from_config(cls, conf_path : str, key : Optional[str] = 'llm') -> 'MambaLLM':
        '''
        Construct a MambaLLM from a configuration file.
        '''
    ...
    def generate(
        self,
        # Replaced str | List[str] with Union[str, List[str]]
